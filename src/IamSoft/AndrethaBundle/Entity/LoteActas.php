 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="IamSoft\AndrethaBundle\Entity\LoteActasRepository")
 */
class LoteActas
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="RegistroEscribano", inversedBy="lotesActas")
    ...
    {
    	$repository=$entityManager->getRepository('IamSoftAndrethaBundle:LoteActas');
